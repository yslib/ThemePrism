...
这个在ThemePrism里非常重要，**它不应该退化成纯左右键轮询**。
...
## 4. 你的 ThemePrism 里，涉及到哪些控件类型

下面按你当前 ThemePrism 的数据模型来映射。
...
## 5. 你的 ThemePrism，最终可以归结成哪些“基础交互原语”
...
这 10 个已经足够支撑你的 ThemePrism，也足够支撑很多别的配置型 / 设计型工具。

---

## 11. 回到你的 ThemePrism，推荐的控件映射
...
**你的 ThemePrism 最值得统一抽象的核心控件只有 5 个：**
